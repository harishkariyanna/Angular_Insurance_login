        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriversLicenseNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PoliceReportNumber = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "View", null, "ViewUsers", "User" },
                    { 2, "Create", null, "CreateUsers", "User" },
                    { 3, "Update", null, "UpdateUsers", "User" },
                    { 4, "Delete", null, "DeleteUsers", "User" },
                    { 5, "View", null, "ViewPolicies", "Policy" },
                    { 6, "Create", null, "CreatePolicies", "Policy" },
                    { 7, "Update", null, "UpdatePolicies", "Policy" },
                    { 8, "Delete", null, "DeletePolicies", "Policy" },
                    { 9, "View", null, "ViewClaims", "Claim" },
                    { 10, "Create", null, "CreateClaims", "Claim" },
                    { 11, "Update", null, "UpdateClaims", "Claim" },
                    { 12, "Approve", null, "ApproveClaims", "Claim" },
                    { 13, "View", null, "ViewReports", "Report" },
                    { 14, "Generate", null, "GenerateReports", "Report" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Insurance Agent", "Agent" },
                    { 3, "Insurance Customer", "Customer" },
                    { 4, "Insurance Manager", "Manager" },
                    { 5, "Insurance Underwriter", "Underwriter" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_Status_Priority",
                table: "Claims",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Policies_CustomerId_Status",
                table: "Policies",
